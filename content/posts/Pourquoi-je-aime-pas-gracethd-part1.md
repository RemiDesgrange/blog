...
draft: true
tags: ["Modele", "Telecom", "Design", "Database"]
categories: ["Database", "Français", "Telco"]
---
...
Quand vous avez un réseau vous vous retrouvez vite avec plusieurs centaines de câbles, qui représente plusieurs dizaines de milliers de fibres, et donc de connexions entrent elles. Dans toutes les tables, la clé primaire est un `varchar`
